...
class TestSchemaDiff(unittest.TestCase):
    ...
    def test_schema_diff(self) -> None:
        ...
        Since the handler functions are called by dispatch in the SchemaDiff
        class, we activate them manually here to ensure test coverage.
        """
        ...
        FormattedSchemaDiff(schema1, schema2)._collect_values_changed(diff["values_changed"])
        ...
        # Call formatted handler function
        FormattedSchemaDiff(schema1, schema2)._collect_iterable_item_added(diff["iterable_item_added"])
        ...
        # Call formatted handler function
        FormattedSchemaDiff(schema1, schema2)._collect_iterable_item_removed(diff["iterable_item_removed"])
        ...
        # Call formatted handler function
        print("Diff:", diff)
        FormattedSchemaDiff(schema1, schema2)._collect_dictionary_item_added(diff["dictionary_item_added"])
        ...
        # Call formatted handler function
        FormattedSchemaDiff(schema1, schema2)._collect_dictionary_item_removed(
    ...
    def test_index_diff(self) -> None:
        ...
        # Print the diff to ensure it works without errors
