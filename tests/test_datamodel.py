...
"""
    ...
    def test_schema_resource(self) -> None:
        """Test loading schemas as internal resources."""
        ...
        self.assertEqual(renamed_col.datatype, "int")  # Inherited from source
...
"""
    ...
    def test_ref_schema_serialization(self) -> None:
        ...
        try:
            ...
            self.fail("The column refs are missing after deserialization: " + str(e))
