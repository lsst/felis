...
In VOTable, this is similar to the FIELDref and PARAMref objects. It's
also similar a GROUP nested in a GROUP, which provides an implicit
reference where the nested GROUP would have an implicit reference to the
parent.
